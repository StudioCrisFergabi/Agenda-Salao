...
O site agora é **multi-página de verdade**: cada item do menu abre uma página
própria (`sobre.html`, `servicos.html`, etc.), em vez de rolar até um trecho
da mesma página.
...
├── agendar.html           agendamento (passo a passo)
...
│   ├── common.js          menu, WhatsApp, rodapé — compartilhado por todas as páginas
│   ├── services-page.js   lógica da página de serviços
│   ├── gallery-page.js    lógica da página de galeria
│   ├── booking-page.js    lógica da página de agendamento
